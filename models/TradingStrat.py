...
#Applying Strategy Pattern using strategies from BBStrategy.py and MAStrategy.py
class TradingStrategy:
    def __init__(self, fngd_graph, fngu_graph, window_size=20, strategy_choice='both', start_date=None, end_date=None):
        ...
        ma.calculate_moving_average() #Always calculate moving average for MA Strategy and BB Strategy
